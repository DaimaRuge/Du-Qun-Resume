...
# ============ 邮件内容 ============
EMAIL_SUBJECT = "🎯 每日猎头任务汇总 - 2026-02-28（上午场）"

EMAIL_BODY = """你好！

这是2026年2月28日上午场的猎头任务汇总报告。

## 📊 今日搜索统计

**执行时间**: 2026-02-28 10:00
**搜索链接**: 25个
...
- [AI Product Director](https://search.51job.com/list/000000,000000,0000,00,9,99,AI%20Product%20Director,2,1.html)
- [智能家居负责人](https://search.51job.com/list/000000,000000,0000,00,9,99,智能家居负责人,2,1.html)
- [Smart Home Lead](https://search.51job.com/list/000000,000000,0000,00,9,99,Smart%20Home%20Lead,2,1.html)
...
- [AI Product Director](https://www.lagou.com/wn/zhaopin?kd=AI%20Product%20Director)
- [智能家居负责人](https://www.lagou.com/wn/zhaopin?kd=智能家居负责人)
- [Smart Home Lead](https://www.lagou.com/wn/zhaopin?kd=Smart%20Home%20Lead)
...
1. **优先顺序**: LinkedIn（国际化公司）→ 猎聘（中高端职位）→ BOSS直聘（快速响应）→ 企业官网
2. **每日任务**: 
   - 上午10:00-11:00：搜索并投递5-10个职位
   - 下午14:00-15:00：跟进投递状态，寻找新机会
3. **重点方向**: AI产品总监/负责人、智能家居产品管理、AIoT战略规划、智能硬件创新
4. **投递策略**: 突出AI产品经验（HomeGPT、AI烤箱）、强调0-1业务操盘能力、量化成果（5亿营收、$1000万成本优化）
